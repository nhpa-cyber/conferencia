...
import { Truck, Clock, Calendar, Check, Save, RefreshCw, AlertCircle, FileSpreadsheet, MapPin, AlertTriangle, BarChart3, Plus, MessageSquare } from 'lucide-react';
...
export default function MonitoramentoView({
  ...
  const routesForSelectedDate = importedRoutes.filter(r => r.routeDate === selectedDate && r.status !== 'fechado');
                            ...
                            <div className="pt-2 border-t border-indigo-150 space-y-2">
                              ...
                              <div className="flex gap-2 items-end">
                                <textarea
                                  ...
                                  placeholder={
                                    obsAuthor === 'Financeiro'
                                      ? "Ex: Cliente NB 4593 possui comodatos de 5 caixas Heineken e recolhas pendentes de vasilhames."
